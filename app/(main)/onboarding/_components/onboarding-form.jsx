...
const OnBoardingForm = ({ industries }) => {
  ...
  const onSubmit = async (values) => {
    try {
      ...
      console.error("Onboarding submission handling error:", error);
    }
  };

  // Triggers success messaging and routes cleanly to dashboard workspaces
  useEffect(() => {
  ...
  // Captures and outputs backend database errors elegantly in client-side toasts
  useEffect(() => {
    if (updateError) {
